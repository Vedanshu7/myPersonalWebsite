  ...
  return (
    <main className="min-h-screen bg-black flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        {error && (
          <p className="font-mono text-xs text-red-400 mb-6">
        ...
        >
          <button
            type="submit"
            className="w-full h-9 rounded-full bg-white text-black font-mono text-sm font-medium hover:bg-white/90 transition-colors flex items-center justify-center gap-2"
          >
