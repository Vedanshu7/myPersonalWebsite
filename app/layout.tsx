...
export const metadata: Metadata = {
  ...
  description:
    "Vedanshu Joshi is a Software Engineer with an MS in Computer Science from Purdue University, building full-stack products, agentic AI systems, data pipelines, and cloud-native services.",
  keywords: [
    "Vedanshu Joshi",
    "software engineer",
  ...
  openGraph: {
    ...
    description:
      "Full-stack engineer with MS Computer Science from Purdue University. Building agentic AI systems, data pipelines, and cloud-native services.",
    url: BASE,
